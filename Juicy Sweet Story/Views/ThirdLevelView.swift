...
struct ThirdLevelView: View {
    ...
    @State var bestTime = UserDefaults.standard.integer(forKey: UserDefaultsKey.bestTime3Level)
                            ...
                            Image("3.\(puzzle)")
                                ...
                                .onChange(of: vm.randomPuzzles) { newValue in
                                    if vm.randomPuzzles == solvedPuzzles {
                                        ...
                                        gameTime = 160 - vm.timeRemaining
                                        if gameTime < bestTime {
                                            UserDefaults.standard.set(gameTime, forKey: UserDefaultsKey.bestTime3Level)
                                            bestTime = gameTime
                                        }
                                        if bestTime == 0 {
                                            bestTime = gameTime
